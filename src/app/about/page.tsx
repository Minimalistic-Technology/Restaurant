...
const About = () => {
  return (
    <div className='w-full h-full font-serif pt-13'>
        ...
        <div className='px-30 py-20 flex flex-col'>
            ...
            <div className=''>
                ...
                <div className='border-2 rounded-md flex flex-col gap-2 items-center justify-center box-border w-2xs h-30 hover:-translate-y-8 transition-all duration-300'>
